...
public enum Language {
  ...
  public static String getString(String key, RoutingContext ctx) {
    return getString(key, getLanguage(ctx));
  }

  public static Single<JsonObject> getJsonTranslations(String lang) {
  ...
  public static String getLanguage(RoutingContext ctx) {
    Cookie lang = ctx.getCookie(LANGUAGE);
    return lang != null ? lang.getValue() : ENGLISH.getLocale().getLanguage();
  }
