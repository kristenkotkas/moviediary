...
public class LocalDatabase {
    private static final String SQL_TRUNCATE_TABLES = "TRUNCATE TABLE Users;" +
    ...
    private static final String SQL_CREATE_MOVIES = "CREATE TABLE Movies (\n" +
            "  Id    INT NOT NULL AUTO_INCREMENT PRIMARY KEY,\n" +
            "  Title VARCHAR(100) NOT NULL,\n" +
            "  Year  SMALLINT NOT NULL,\n" +
            "  Image VARCHAR(64)  NOT NULL);";
    private static final String SQL_CREATE_VIEWS = "CREATE TABLE Views (\n" +
            "  Id        INT NOT NULL AUTO_INCREMENT PRIMARY KEY,\n" +
    ...
    private static final String SQL_CREATE_WISHLIST = "CREATE TABLE Wishlist (" +
            "  MovieId  INT                     NOT NULL,\n" +
            "  Username VARCHAR(100)            NOT NULL,\n" +
    ...
    private static final String SQL_INSERT_FORM_SETTING = "INSERT INTO Settings (Username, RuntimeType, Verified) " +
            "VALUES ('unittest@kyngas.eu', 'default', '1')";
    private static final String SQL_INSERT_FB_USER = "INSERT INTO Users " +
            "(Username, Firstname, Lastname, Password, Salt) " +
    ...
    private static final String SQL_INSERT_FB_SETTING = "INSERT INTO Settings (Username, RuntimeType, Verified) " +
            "VALUES ('facebook_ekubamn_tester@tfbnw.net', 'default', '0')";
    private static final String SQL_INSERT_MOVIES_HOBBIT = "INSERT INTO Movies (Id, Title, Year, Image) " +
            "VALUES ('49051', 'The Hobbit: An Unexpected Journey', '2012', '/w29Guo6FX6fxzH86f8iAbEhQEFC.jpg')";
    private static final String SQL_INSERT_MOVIES_GHOST = "INSERT INTO Movies (Id, Title, Year, Image) " +
            "VALUES ('315837', 'Ghost in the Shell', '2017', '/si1ZyELNHdPUZw4pXR5KjMIIsBF.jpg')";
    private static final String SQL_INSERT_WISHLIST = "INSERT INTO Wishlist (Username, MovieId, Time) " +
            "VALUES ('unittest@kyngas.eu', '49051', '" + currentTimeMillis() + "')";
    private static final String SQL_INSERT_VIEW = "INSERT INTO Views " +
